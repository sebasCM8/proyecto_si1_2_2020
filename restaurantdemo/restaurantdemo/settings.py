"""
Django settings for restaurantdemo project.
...
SECRET_KEY = 'i6()k+=h-17k!v2dmy92ddu2yn0^+25=&hxw1(*o#7=hsaaod#'
...
ROOT_URLCONF = 'restaurantdemo.urls'
...
WSGI_APPLICATION = 'restaurantdemo.wsgi.application'
